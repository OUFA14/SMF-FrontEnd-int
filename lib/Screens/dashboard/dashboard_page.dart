...
// --- باقي الـ Widgetات المساعدة (يجب أن تكون خارج الكلاسات الأخرى) ---
      ...
      builder: (context, _) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [
                palette.redDark.withOpacity(0.45),
                palette.card,
                palette.redDark.withOpacity(0.36),
              ],
            ),
            borderRadius: BorderRadius.circular(12),
            border: Border.all(color: palette.red.withOpacity(0.75)),
            boxShadow: [
              BoxShadow(
                color: palette.red.withOpacity(glow),
                blurRadius: 22,
              ),
            ],
          ),
          child: Row(
            children: [
              Container(
                ...
                height: 42,
                decoration: BoxDecoration(
                  color: palette.red.withOpacity(0.16),
                  borderRadius: BorderRadius.circular(10),
                  border: Border.all(color: palette.red.withOpacity(0.85)),
                ),
            ...
            child: Row(
              children: [
                Container(
                  ...
                  height: 34,
                  decoration: BoxDecoration(
                    color: event.$4.withOpacity(0.16),
                    shape: BoxShape.circle,
                    border: Border.all(color: event.$4.withOpacity(0.6)),
                  ),
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    height: 30,
                    decoration: BoxDecoration(
                      color: items[i].$4.withOpacity(0.14),
                      shape: BoxShape.circle,
                    ),
...
class _StatCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: active ? palette.redDark.withOpacity(0.32) : palette.card,
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
          color: active ? palette.red.withOpacity(0.55) : palette.border,
        ),
      ),
      child: Row(
        children: [
          Container(
            ...
            height: 42,
            decoration: BoxDecoration(
              color: spec.color.withOpacity(0.13),
              shape: BoxShape.circle,
      ...
      child: Row(
        children: [
          Container(
            ...
            height: 34,
            decoration: BoxDecoration(
              color: palette.red.withOpacity(0.13),
              borderRadius: BorderRadius.circular(8),
            ),
...
class _BannerAction extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        border: Border(
          left: BorderSide(color: palette.red.withOpacity(0.24)),
        ),
      ),
      child: Row(
        children: [
